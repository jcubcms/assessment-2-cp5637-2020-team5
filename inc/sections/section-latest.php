<?php 
/**
 * Template part for displaying Latest Section
 *
 *@package edunxt
 */
?>
<?php 
	 $latest_title    = edunxt_get_option( 'latest_title' );
	 $latest_category = edunxt_get_option( 'latest_category' );
?> 
  ...
  <div class="section-content col-3">
  	<?php 
        ...
        if ( absint( $latest_category ) > 0 ) {
            $args['cat'] = absint( $latest_category );
        }
				    	...
				    	<div class="post-item">
					      	<?php if(has_post_thumbnail()):?>
						        <div class="featured-image">
						        	<a href="<?php the_permalink();?>"><?php the_post_thumbnail('edunxt-blog');?></a>  
						        </div>
					    	<?php endif?>
