...
*/
 jQuery(document).ready(function($) {
    $('#edunxt-img-container li label img').click(function(){    	
        $('#edunxt-img-container li').each(function(){
            $(this).find('img').removeClass ('edunxt-radio-img-selected') ;
        });
        $(this).addClass ('edunxt-radio-img-selected') ;
    }); 
    ...
    $( document ).on( 'click', '.customize_multi_add_field', edunxt_customize_multi_add_field )
        .on( 'change', '.customize_multi_single_field', edunxt_customize_multi_single_field )
        .on( 'click', '.customize_multi_remove_field', edunxt_customize_multi_remove_field )
    ...
    function edunxt_customize_multi_add_field(e) {
        ...
        e.preventDefault();
            ...
            edunxt_customize_multi_write( $control );
    }

    function edunxt_customize_multi_single_field() {
        var $control = $( this ).parents( '.customize_multi_input' );
        edunxt_customize_multi_write( $control );
    }

    function edunxt_customize_multi_remove_field(e) {
        e.preventDefault();
        var $this = $( this );
        var $control = $this.parents( '.customize_multi_input' );
        $this.parent().remove();
    ...
    function edunxt_customize_multi_write( $element) {
